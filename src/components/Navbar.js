...
const Navbar = () => {
  ...
  return (
    <div className="flex justify-between items-center font-Work-sans px-4 py-4 bg-[#EBFFED] lg:justify-between lg:px-12">
      <div className="lg:hidden" onClick={handleSidebar}>
        <FcMenu
          className="block w-6 h-6 dark:text-gray-300 hover:text-primary"
          aria-hidden="true"
        />
      </div>
      ...
      <div className="hidden md:block lg:block">
        <div className="flex items-center space-x-4">
          ...
          >
            ...
            />
            <span
              className={`${isDashboard ? "text-primary" : "text-gray-500"}`}
            >
              Dashboard
            </span>
          </div>
    ...
    <>
      <Menu.Item>
        <span
          ...
          className="flex items-center justify-between gap-2 p-3 text-sm hover:bg-gray-100"
        >
