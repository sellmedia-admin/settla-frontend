				...
				<div className="min-h-screen px-4 text-center">
					...
					<div className="inline-block w-full max-w-lg p-4 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
						...
						<p className="leading-7 text-grey-title">
							Welcome to Mondu, your email has been received and you will soon be ready to get started. Mondu is your simple solution to
						...
						<p className="mb-3 leading-7 text-grey-title">
							Now you are equiped with all you need, but if you need help getting started, contact info@mondu.io and you'll be up and
							running in no time.
						</p>
