        ...
        <div className="bg-bg bg-cover bg-no-repeat w-full h-full">
          <nav className="nav_links flex items-center justify-between max-w-default mx-auto px-4 py-6 md:px-0">
            <div className="flex space-x-2">
              <Link to="/">
                <img alt="logo" src={imgs.logoWhite} className="logo" />
              </Link>
            </div>
            <div className="flex items-center text-[16px] gap-2 text-white">
              <Link to="/features" className="px-2 hover:text-black">
                Features
              </Link>
              <Link to="/about" className="px-2 hover:text-black">
                Company
              </Link>
              <Link to="#" className="px-2 hover:text-black">
                Blog
              </Link>
              {/* <Link to="/case-study" className="px-2 hover:text-black">Case Studies</Link> */}
              <Link to="/contact" className="px-2 hover:text-black font-bold">
                Contact Us
              </Link>
            </div>
            <Link
              to="/login"
              className="px-5 py-2 bg-white text-primary border border-white hover:bg-white hover:text-black hover:border-black flex justify-center items-center w-[121px] h-[48px] rounded-8"
            >
              Login
            </Link>
          </nav>
            ...
            <div className="max-w-760 mx-auto text-center text-white">
              ...
              <div className="max-w-508 mx-auto mt-5">
                <p className="text-white">
                  Our account specialists are ready to help you start using
                  Settla, making life easier for you and your partners.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-16">
          <div className="grid content-center px-4 my-8 md:grid-cols-2 max-w-default mx-auto">
            ...
            <div className="max-w-473 ml-auto col-span-1 text-black">
              ...
              <div>
                <p className="mb-6">
                  If you need support, you’ve come to the right place. Here you
                  can browse our frequently asked questions or get in touch with
                  a team member. It’s simple.
                </p>
                {/* TODO: */}
                ...
                <div className="flex mt-2">
                  <Link
                    to="#"
                    className="h-[41px] w-[41px] rounded-full flex justify-center items-center bg-primary/10 mr-3"
                  >
          ...
          <div className="grid content-center px-4 my-8 md:grid-cols-2 max-w-default mx-auto">
            <div className="max-w-473 mr-auto col-span-1">
              <div className="mb-4">
                ...
                <p className="mb-6">
                  This is the best way to help us build a better product and
