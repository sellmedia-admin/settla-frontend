...
export const forgotPassword = (data) =>
  server.post("/auth/forget-password", data);

export const resendOTP = (data) => server.post("/auth/resend-otp", data);

export const acceptMembership = (data) =>
  server.post("/user/team/accept-memebership", data);

export const resetPassword = ({ token, data }) =>
  server.patch(`/auth/reset-password/${token}`, data);

export const verifyAccount = ({ token, ...data }) =>
  server.post("auth/verify-account", data, {
    headers: { Authorization: `Bearer ${token}` },
  });

export const updateUser = ({ token, ...data }) => {
  return server.patch("/user/profile", data, {
    headers: { Authorization: `Bearer ${token}` },
  });
};

export const updateUserWhenLoggedIn = (data) =>
  server.patch("/user/profile", data);

export const updateUserPassword = (data) =>
  server.patch("/user/updatePassword", data);
...
export const addTeamMember = (data) =>
  server.post("/user/team/addMembers", data);

export const editPermission = (data) =>
  server.post("/user/team/add-permissions", data);

export const deleteTeamMember = (data) =>
  server.delete("/user/team/delete", data);

export const getBeneficiaries = (params) =>
  server.get("/user/beneficiary", { params });

export const createBeneficiary = (data) =>
  server.post("/user/beneficiary", data);

export const editBeneficiary = ({ id, ...data }) =>
  server.patch(`/user/beneficiary/${id}`, data);

export const deleteBeneficiary = (id) =>
  server.delete(`/user/beneficiary/${id}`);

export const uploadKYC = ({ id, ...data }) =>
  server.post(`/upload/kyc/${id}`, data, {
    headers: { "Content-Type": "multipart/form-data" },
  });

export const createFintechPerson = (data) =>
  server.post(`/account/create`, data);

export const createFintechBusiness = (data) =>
  server.post(`/account/create-business`, data);

export const createVirtualAccount = (data) =>
  server.post(`/account/create-virtual`, data);

export const createPayoutDestination = () => server.post(`/account/payout`);

export const initializeTransfer = (data) =>
  server.post(`/account/initialize-transfer`, data);

export const finalizeTransfer = (data) =>
  server.post(`/account/finalize-transfer`, data);

export const finalizeLocalTransfer = (data) =>
  server.post(`/account/finalize-local-transfer`, data);

export const initializeLocalTransfer = (data) =>
  server.post(`/account/initialize-local-transfer`, data);

export const getConversionRates = () => server.get(`/account/get-rate`);

export const getVirtualAccount = (id) =>
  server.get(`/account/fetch-virtual/${id}`);

export const getWalletBalance = (params) =>
  server.get(`/account/get-balance`, { params });

export const getTransactions = (params) =>
  server.get(`/account/transactions`, { params });

export const swapCurrencies = (params) =>
  server.post(`/account/swap-currency`, params);

export const transferFromUSD = (params) =>
  server.post(`/account/transfer-from-usd-wallet`, params);
...
export const verifyBankAccount = (data) =>
  server.post("/account/resolve-bank", data);

export const uploadSupportingDocument = (data) =>
  server.post("/account/upload-supporting-doc", data, {
    headers: { "Content-Type": "multipart/form-data" },
  });

export const getNotifications = (params) =>
  server.get("/user/notifications", { params });
